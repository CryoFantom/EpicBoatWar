...
begin
	...
	writeln(' ');
	writeln('Utilisez le terrain à votre avantage, les montagnes bloquent la vision et les tirs et les récifs empêchent les bateaux de ce déplacé mais ne bloque ni la vision ni les tirs.');
	writeln(' ');
	writeln('Le tour se découpent en deux phases, une phase de déplacement et une phase de tir.');
	writeln(' ');
	writeln('Phase de déplacement :');
	writeln('- Utilisé les flèches droite et gauche afin de sélectionner le bateau que vous voulez déplacer puis valider avec la touche « Entrer ».');
	...
	writeln('- Utilisé les flèches droite et gauche afin de sélectionner le bateau avec le quel vous voulez tirer puis valider avec la touche « Entrer ».');
